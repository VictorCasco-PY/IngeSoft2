...
const CajaMainForm = ({ setSesionAbierta }) => {
  ...
  useEffect(() => {
    ...
    if (!CajaStorage.getSesionCajaId()) {
      ...
      toast.error(
        "Ya tienes una caja abierta, no deberías de estar viendo esto..."
      );
    }
  }, [currentPage]);
  ...
  const handleAbrirCaja = async (values) => {
    ...
    if (success && success["id"] && success["idCaja"]) {
      //si se devuelve un id de sesion
    ...
    <>
      ...
      <CartaPrincipal>
        ...
        <div className="d-flex align-items-center justify-content-center my-auto">
          <div
            className="d-flex flex-column p-4 py-5 card "
            style={{ width: "30rem", marginLeft: 0, marginRight: 0 }}
          >
            <Formik
              initialValues={{
                id_caja: "",
              ...
              validationSchema={Yup.object({
                id_caja: Yup.string().required("Requerido"),
              })}
            ...
            >
              <Form
                className="d-flex flex-column gap-2 formaFont"
                style={{ minHeight: 364 }}
              >
                <h1>Abrir caja</h1>
                {cargandoCajas ? (
                  ...
                  <p className="pt-2">
                    No se encontraron cajas, registra una nueva caja.
                  </p>
                )}
                ...
                <Btn
                  id="btn-abrir-caja"
                  type="primary"
                  className="mt-3 align-self-end mt-auto"
                  loading={cargandoSesion}
                  disabled={cargandoSesion || cargandoCajas || abrirDisabled}
                  submit
                >
                  Abrir Caja
                </Btn>
